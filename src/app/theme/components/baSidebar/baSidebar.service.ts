...
import {evaluatorMenuItems} from '../../../menu/evaluator.menu';
...
export class BaSidebarService {
  ...
  public getMenuItems(app: any): Array<Object> {
    let menuItems;
    if (!app) {
      app = {};
      app.key = "configui"; //By default configui menuitems are loaded
    }
    switch (app.key) {
      case "configui":
        menuItems = configuiMenuItems;
        break;
      case "evaluator":
        menuItems = evaluatorMenuItems;
        break;
      case "applicant-gateway":
        menuItems = applicantuiMenuItems;
        break;
      case "applicant-ux":
        menuItems = applicantuxMenuItems;
        break;
      default:
        menuItems = configuiMenuItems;
        break;
